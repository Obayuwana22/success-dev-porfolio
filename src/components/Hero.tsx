  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-4 sm:px-6 pt-24 sm:pt-20">
      <div className="flex flex-col justify-center items-center">
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-400 mb-8 sm:mb-12 leading-relaxed max-w-2xl font-light">
              I'm a developer who hates slow websites. I spend my time auditing
              bundles, crafting accessible design systems, and pushing the
              boundaries of what the browser can do.
            </p>

            <div className="flex flex-col sm:flex-row flex-wrap gap-5 sm:gap-8 items-start sm:items-center">
              <a
                href="#projects"
                className="group relative px-6 sm:px-8 py-3 sm:py-4 overflow-hidden rounded-md bg-white text-black font-bold uppercase tracking-tighter transition-all w-full sm:w-auto text-center"
              >
              ...
              <a
                href="#contact"
                className="mono text-xs sm:text-sm hover:text-indigo-500 transition-colors border-b border-white/20 pb-1"
              >
                [ get_in_touch ]
              </a>
            </div>
        ...
        <div className="absolute right-8 hidden xl:block opacity-10 rotate-45">
          <span className="mono text-9xl font-bold select-none tracking-tighter">
            DEVELOPER
          </span>
        </div>
      </div>
