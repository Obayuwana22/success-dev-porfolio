      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-20">
          <div className="lg:w-1/3">
            ...
            <p className="text-gray-400 leading-relaxed mb-12 italic border-l-2 border-indigo-600 pl-6">
          ...
          <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div key={category.title} className="p-8 border border-white/5 bg-white/1 rounded-lg group hover:border-indigo-500/20 transition-all">
                ...
                <div className="flex flex-wrap gap-3">
                  {category.skills.map((skill) => (
                    <span key={skill} className="px-3 py-1.5 rounded-sm border border-white/10 text-xs font-medium hover:bg-white hover:text-black transition-all cursor-default">
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            <div className="p-8 border border-dashed border-white/10 flex flex-col justify-center rounded-lg">
